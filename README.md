...
> Release note for v5.0.1: arbitrage mode now enforces the reserve SOC across the full battery fleet, and EV charging now consumes scheduled arbitrage power before the remainder is exported to grid.
