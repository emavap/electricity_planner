...
# --- Algorithm constants ---
# These values define the core behavior of the decision engine and strategies.
# They are not user-configurable but are centralized here for clarity and tuning.
CONFIDENCE_BASE = 0.6
CONFIDENCE_RANGE_MIN = 0.3
CONFIDENCE_RANGE_MAX = 0.9
CONFIDENCE_LOW_SOC_ADJUSTMENT = -0.1
CONFIDENCE_HIGH_SOC_ADJUSTMENT = 0.1
CONFIDENCE_SOLAR_ADJUSTMENT = 0.1
LOW_SOC_THRESHOLD = 40
MEDIUM_SOC_THRESHOLD = 60
HIGH_SOC_THRESHOLD = 70
VERY_HIGH_SOC_THRESHOLD = 80
SOC_SAFETY_MARGIN = 2.0
SOC_BUFFER_FOR_SOLAR_WASTE = 5.0
SIGNIFICANT_PRICE_DROP_THRESHOLD = 0.1
MAX_CAR_CHARGER_POWER = 22000
